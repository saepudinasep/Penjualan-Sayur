...
// $qcekpass = mysqli_query($koneksi, "SELECT * FROM tb_users WHERE username = '$_SESSION[username]'");
...
$quser = mysqli_query($koneksi, "SELECT * FROM tb_pasar WHERE user_id='$profile[user_id]'");
            ...
            <div id="content">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?= $user['nama_pasar']; ?></span>
                ...
                <div class="container-fluid">
                    ...
                    switch ($menu) {
                        ...
                        case 'delete_product':
                            $id = $_POST['id'];
                            mysqli_query($koneksi, "DELETE FROM tb_produk WHERE produk_id='$id'");
