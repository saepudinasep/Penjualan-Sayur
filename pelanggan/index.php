...
} elseif ($_SESSION['user_type'] == "Toko") {
...
$quser = mysqli_query($koneksi, "SELECT * FROM tb_pelanggan WHERE user_id = '$profile[user_id]'");
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item <?php
                                ...
                                ?>">
                <a class="nav-link" href="?menu=store">
            ...
            <li class="nav-item <?php
                                if ($menu == "riwayat_transaksi") {
                                    echo "active";
                                }
                                ?>">
                <a class="nav-link" href="?menu=riwayat_transaksi">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    ?>
                            <script>
                                location.href = "?menu=vtoko";
                            </script>
                        <?php
                            break;

                        case 'vtoko':
                            include "menu/view_toko.php";
                            break;
                    ...
                    <?php
                        ...
                        case 'riwayat_transaksi':
                            include "menu/riwayat_transaksi.php";
                            break;
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; Asep Saepudin 2021</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
