    ...
    <div class="card-body">
        <div class="table-responsive mb-4">
            <table id="itemTable" class="table table-bordered text-center small" width="100%" cellspacing="0">
                ...
                <tbody>
                    <?php
                    $q = mysqli_query($koneksi, "SELECT * FROM tb_cart c JOIN tb_produk p ON c.produk_id=p.produk_id WHERE pelanggan_id='$user[pelanggan_id]' AND jenis='nBuy'");
                    $no = 1;
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        insertButton.addEventListener("click", function() {
            ...
            var pelanggan_id = "<?= $user['pelanggan_id']; ?>";
